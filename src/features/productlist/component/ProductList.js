...
import { fetchAllProductsByFiltersAsync, selectBrands, selectCategory, selectAllProducts, selectTotalItem, fetchAllBrandsAsync, fetchAllCategoryAsync, selectProductStatus } from '../productSlice';
import { Dialog, Disclosure, Menu, Transition } from '@headlessui/react'
import { XMarkIcon } from '@heroicons/react/24/outline'
import { ChevronDownIcon, FunnelIcon, MinusIcon, StarIcon, PlusIcon, Squares2X2Icon } from '@heroicons/react/20/solid'
          ...
          <div className="mt-6 grid grid-cols-1 gap-x-6 gap-y-10 sm:grid-cols-2 lg:grid-cols-3 xl:gap-x-8">
            {products.map((product) => (
              ...
              <Link to={`/product-detail/${product.id}`} key={product.id}>
                <div className="group relative border-solid border-2 border-gray-500 p-2">
